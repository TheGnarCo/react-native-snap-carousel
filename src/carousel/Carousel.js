...
export default class Carousel extends Component {
  ...
  constructor(props) {
    ...
    this._onScrollEndDrag = !props.enableMomentum
      ...
      : this._onScrollEndDragMomentum.bind(this)
    ...
    // onPanResponderEnd: this.onPresetTouchEnd,
    // onPanResponderGrant: this.onPresetTouchStart,
    // onPanResponderMove: this.onPresetTouchMove,
    // onPanResponderReject: this.onPresetTouchReject,
    // onPanResponderRelease: this.onPresetTouchRelease,
    // onPanResponderTerminate: this.onPresetTouchTerminate,
    ...
    this.panResponder = PanResponder.create({
      onMoveShouldSetPanResponder: (evt, gestureState) => {
        ...
        this.setState({ gestureStateVx: gestureState.vx })
        return false
      },
    })
  ...
  _onScrollEndDragMomentum(event) {
    const { gestureStateVx } = this.state
    this._scrollEndOffset = this._currentContentOffset
    this._scrollEndActive = this._getActiveItem(this._scrollEndOffset)

    // console.log('gestureStateDx', this.state.gestureStateDx)
    // console.log('gestureStateVx', this.state.gestureStateVx)
